package com.decard.zj.founctiontest.download.apkinstaller;
...
public class PackageUtils {
    ...
    public static final int install(Context context, String filePath, String packageName) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            return installSilentInN(context, filePath, " -r " + getInstallLocationParams(), context.getPackageName());
        } else {
            return installSilentLow(context, filePath, " -r " + getInstallLocationParams());
        }
    }
     ...
     * @return
     */
    public static int installSilentInN(Context context, String filePath, String pmParams, String packageName) {
         ...
         **/
        StringBuilder command = new StringBuilder().append("pm install -i ")
                .append(packageName)
                .append(" --user -1 ")
     ...
     */
    public static int installSilentLow(Context context, String filePath, String pmParams) {
        if (filePath == null || filePath.length() == 0) {
            return INSTALL_FAILED_INVALID_URI;
        }
         ...
         * android:name="android.permission.INSTALL_PACKAGES" /> in mainfest
         **/
        StringBuilder command = new StringBuilder().append("pm install ")
    ...
    public static Boolean isTopActivity(Context context, String packageName) {
        if (context == null || Utils.isEmpty(packageName)) {
            return null;
        }

        ActivityManager activityManager = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<RunningTaskInfo> tasksInfo = activityManager.getRunningTasks(1);
        if (Utils.isEmpty(tasksInfo)) {
            return null;
        }
        try {
    ...
    public static int getInstallLocation() {
        ShellUtils.CommandResult commandResult = ShellUtils.execCommand(
                "pm get-install-location", false, true);
     ...
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if
    ...
    /**
     * Installation return code<br/>
     * if the parser encountered a bad shared user taskId name in the manifest.
     */
