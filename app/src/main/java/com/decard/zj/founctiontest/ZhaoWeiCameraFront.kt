 ...
 */
class ZhaoWeiCameraFront {


    private var mCameraId = "1"//摄像头id（通常0代表后置摄像头，1代表前置摄像头）
...
//        val instance: ZhaoWeiCameraFront get() = Holder.cameraUtils

        private val TAG = "----ZhaoWeiCameraFront"
    ...
    private object Holder {
        val cameraUtils = ZhaoWeiCameraFront()
    }
    ...
    private fun startBackgroundThread() {
        backgroundThread = HandlerThread("CameraFont").also { it.start() }
