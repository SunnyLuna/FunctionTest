 ...
 */
class CustomCamera2 : CameraUtils() {
    ...
    private var mIPhotoInterface: IPhotoInterface? = null
    ...
    companion object {
        ...
        val instance: CustomCamera2 get() = Holder.cameraUtils

        private val TAG = "----CustomCamera2"
    ...
    override fun takePhoto(iPhotoInterface: IPhotoInterface) {
        this.mIPhotoInterface = iPhotoInterface
        try {
            ...
            // 根据设备方向计算设置照片的方向
            captureRequestBuilder.set(CaptureRequest.JPEG_ORIENTATION, setCaptureOrientation())
            //设置拍照监听
